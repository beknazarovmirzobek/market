            ...
            <div className="navbar">
                <div className="container-box d-flex">
                    ...
                    <form className="d-flex justify-content-between search" role="search">
                        <input className="w-75 border-0" type="search" id="search" placeholder={t.search_product} aria-label="Search" ref={ref} />
                        <div>
                            <button className="btn"><img src={Иконка_удалить} alt="" onClick={(e) => { deleteSearch(e) }} /></button>
                    ...
                    <NavLink to="/Корзина" className="text-decoration-none d-flex m-0 p-0">
                        ...
                        <p className="fw-bold saved_product">{t.shopping_cart}<br /><span className="text-success">125.000 UZS</span></p>
                    </NavLink>
                </div>
            </div>
        </header>
